...
/* package assign2-0.1.0.0 */
#define VERSION_assign2 "0.1.0.0"
#define MIN_VERSION_assign2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "assign2-0.1.0.0-HR9hU8cIXLf43tgzC2vdOI"

#define CURRENT_PACKAGE_KEY "assign2-0.1.0.0-HR9hU8cIXLf43tgzC2vdOI"
